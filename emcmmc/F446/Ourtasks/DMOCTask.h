...
struct DMOCFUNCTION
{
   // Parameter loaded either by high-flash copy, or hard-coded subroutine
	struct DMOCLC lc; // Fixed parameters, (lc = Local Copy)
...
/* *************************************************************************/
osThreadId xDMOCTaskCreate(uint32_t taskpriority);
/* @brief	: Create task; task handle created is global for all to enjoy!
 * @param	: taskpriority = Task priority (just as it says!)
 * @return	: DMOCTaskHandle
 * *************************************************************************/

 extern TaskHandle_t DMOCTaskHandle;
 extern struct DMOCFUNCTION dmocfunction;
