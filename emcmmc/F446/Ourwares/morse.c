...
#define LEDALL (GPIO_PIN_12|GPIO_PIN_13)
...
__asm__ volatile ("CPSID I");
	...
	for (int i=0; i <2; i++)
	{
		morse_number(x, (GPIO_PIN_12|GPIO_PIN_13));
		delay(TIC_PAUSE, (GPIO_PIN_12|GPIO_PIN_13), GPIO_PIN_SET);	
	}
