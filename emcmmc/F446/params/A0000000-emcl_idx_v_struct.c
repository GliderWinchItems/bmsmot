...
// Cooling motor control
  ...
  /* CHGRATENUM 6 // Number of charger current step multipliers */
  p->lcstring.chgr_rate[0] = 0; // Always zero
  p->lcstring.chgr_rate[1] = 0.08f;
  p->lcstring.chgr_rate[2] = 0.15f;
  p->lcstring.chgr_rate[3] = 0.57f;
  p->lcstring.chgr_rate[4] = 0.70f;
  p->lcstring.chgr_rate[5] = 1.00f; // Max of mininum of nodes' max chg current reported
